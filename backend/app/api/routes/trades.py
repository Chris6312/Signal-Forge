        ...
        for p in positions:
            try:
                out.append({
                    ...
                    "protection_mode": getattr(p, "protection_mode", None),
                    "initial_risk_price": getattr(p, "initial_risk_price", None),
                    "tp1_price": getattr(p, "tp1_price", None),
                    "tp1_hit": getattr(p, "tp1_hit", None),
                    "break_even_floor": getattr(p, "break_even_floor", None),
                    "promoted_floor": getattr(p, "promoted_floor", None),
                    "highest_promoted_floor": getattr(p, "highest_promoted_floor", None),
                    "runner_phase": getattr(p, "runner_phase", None),
                    "milestone_version": getattr(p, "milestone_version", None),
                    "last_protection_update_at": getattr(p, "last_protection_update_at", None),
